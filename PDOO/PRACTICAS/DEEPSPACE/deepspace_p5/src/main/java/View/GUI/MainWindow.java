...
public class MainWindow extends JFrame implements DeepSpaceView{
    ...
    private MainWindow() {
        initComponents();
        appName = "DeepSpace 5.0 - @DanielsP";
        setTitle(appName);
    ...
    private void initComponents() {
        ...
        author.setFont(new java.awt.Font("Ubuntu", 1, 13)); // NOI18N
        author.setForeground(new java.awt.Color(152, 152, 152));
        author.setText("Powered By DanielsP");
