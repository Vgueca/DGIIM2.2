...
/**
 * @brief Representación de un crupier. Esta clase de carácter Singleton se encarga
 * de crear una serie de mazos con diferentes instancias: Supplies, ShieldBoosters
 * Weapons, Hangares y Enemigos, y dispone de diversos métodos para la obtención de diferentes
 * cartas.
 */
class CardDealer {
    ...
    /**
     * @brief Inserta cartas en el mazo de EnemyStarShip
     */
